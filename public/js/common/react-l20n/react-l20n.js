	...
	var Entity = React.createClass({displayName: "Entity",
	  ...
	  render: function() {
	    ...
	    if(this.props.dangerouslySetInnerHTML) {
	      return (
	        React.createElement(ComponentClass, React.__spread({},  props, {dangerouslySetInnerHTML: {__html: this.state.entity}}))
	      );
	    }
	    return (
	      React.createElement(ComponentClass, React.__spread({},  props), this.state.entity)
	    );
	  }
	});
